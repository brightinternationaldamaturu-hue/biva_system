...
https://api.flutterwave.com/v3/transactions/${transaction_id}/ver
  ify, 
{ 
  headers: { 
...
const processedRef =
db.collection("processedPayments").doc(tx_ref); 


// STEP 4: SAFE TRANSACTION 
await db.runTransaction(async (t) => { 
  const processedSnap = await t.get(processedRef); 
  if (processedSnap.exists) { throw new Error("DUPLICATE"); 
  } 
